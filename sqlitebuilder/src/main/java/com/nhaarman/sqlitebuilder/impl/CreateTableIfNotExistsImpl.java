...
class CreateTableIfNotExistsImpl extends BaseSqlPart implements CreateTableIfNotExists {
  ...
  CreateTableIfNotExistsImpl(@Nullable final String databaseName, @NotNull final String tableName, @NotNull final SqlPart previous) {
  ...
  public void prependTo(@NotNull final RawSqlBuilder builder) {
    ...
    builder.prepend("TABLE IF NOT EXISTS ");
  }
