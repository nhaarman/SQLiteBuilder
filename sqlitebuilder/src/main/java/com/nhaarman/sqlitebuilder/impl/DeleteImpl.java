...
class DeleteImpl extends BaseSqlPart implements Delete {
  ...
  @NotNull
  @Override
  public DeleteFrom from(@Nullable final String databaseName, @NotNull final String tableName) {
    return new DeleteFromImpl(databaseName, tableName, this);
  }

  @Override
  public void prependTo(@NotNull final RawSqlBuilder builder) {
    builder.prepend("DELETE");
  }
