...
class WithoutRowIdImpl extends BaseFinishedStatement implements WithoutRowId {

  @NotNull
  private final SqlPart mPrevious;

  WithoutRowIdImpl(@NotNull final SqlPart previous) {
    mPrevious = previous;
  }

  @Override
  public void prependTo(@NotNull final RawSqlBuilder builder) {
    builder.prepend("WITHOUT ROWID");
  }
