...
public class BaseFinishedSqlPartTest {

  @Test
  public void iterator_returnsProperIterator() {
    /* Given */
    SqlPart sqlPart = mock(SqlPart.class);
    TestBaseFinishedSqlPart statement = new TestBaseFinishedSqlPart(sqlPart);
  ...
  private static class TestBaseFinishedSqlPart extends BaseFinishedSqlPart {

    @NotNull
    private final SqlPart mPrevious;

    TestBaseFinishedSqlPart(@NotNull final SqlPart previous) {
      mPrevious = previous;
    }
