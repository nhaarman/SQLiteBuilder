...
public class InsertOrAbortImplTest {

  @Test
  public void prependTo_prependsProperSql() {
    /* Given */
    InsertOrAbortImpl insertOrAbort = new InsertOrAbortImpl();
    RawSqlBuilder builder = new RawSqlBuilderImpl();

    /* When */
    insertOrAbort.prependTo(builder);
  ...
  public void previous_returnsNullValue() {
    ...
    /* When */
    SqlPart result = insertOrAbort.previous();
  ...
  public void intoTable_returnsNotNullValue() {
    ...
    /* When */
    Into result = insertOrAbort.into("my_table");
  ...
  public void intoDatabaseTable_returnsNotNullValue() {
    ...
    /* When */
    Into result = insertOrAbort.into("my_database", "my_table");
